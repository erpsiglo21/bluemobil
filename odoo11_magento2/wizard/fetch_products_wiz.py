...
class ProductsFetchWizard(models.Model):
            ...
            if str(product['id']) not in existing_prod_ids:
                    ...
                    for pic in product['media_gallery_entries']:
                        if 'thumbnail' in pic['types']:
                            image_file = product['media_gallery_entries'][0].get(
                                'file')
                            pro_tmpl = self.env['product.template'].browse(product_tmpl_id[0])
                ...
                if product.get('type_id') == 'configurable':
                    ...
                    if product.get('childs'):
                        ...
                        product_product = self.env['product.product'].search([('product_tmpl_id', '=', product_tmpl_id[0])])
    ...
    def fetch_products_to_odoo(self):
        ...
        type = 'GET'
        categ_list = self.env['magento.connector'].magento_api_call(headers={}, url=categ_url, type=type)
        try:
        ...
        url = '/rest/V1/products?searchCriteria[filter_groups][0][filters][0]' \
              ...
              '[0][value]=configurable&searchCriteria[currentPage]=1&searchCriteria[pageSize]=2'
        type = 'GET'
        ...
        url = '/rest/V1/products?searchCriteria[filter_groups][0][filters][0]' \
              ...
              'neq&searchCriteria[currentPage]=3&searchCriteria[pageSize]=2'
        type = 'GET'
